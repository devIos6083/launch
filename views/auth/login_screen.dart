  ...
  Widget _buildResetPasswordDialog(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Text(
        '비밀번호 재설정',
        style: TextStyle(
          color: AppColors.primaryTextColor, // 흰색에서 진한 색상으로 변경
          fontWeight: FontWeight.bold,
        ),
      ),
      content: Theme(
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  color: AppColors.primaryTextColor, // 더 진한 색상으로 변경
                  fontSize: 12,
                ),
              ),
              const SizedBox(height: 16),
              AppTextField(
                ...
                prefixIcon: Icons.email_outlined,
                validator: Validators.validateEmail,
                style: TextStyle(color: Colors.black87), // 직접 스타일 지정
              ),
            ],
          ),
        ),
