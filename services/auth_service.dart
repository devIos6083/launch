  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<app_user.FirebaseService>(
          create: (_) => app_user.FirebaseServiceImpl(),
        ),
        ...
        // 저장소 레이어
        ProxyProvider2<app_user.FirebaseService, StorageService,
            app_user.FirebaseRepository>(
          update: (_, firebaseService, storageService, __) =>
              app_user.FirebaseRepositoryImpl(
            firebaseService: firebaseService,
            storageService: storageService,
          ),
        ),
        ProxyProvider2<AuthService, StorageService, AuthRepository>(
